...
int main(int argc, char *argv[]) {
    ...
    string con_mask[46] = {"010011000", "010110000", "000110010", "000011010", "001011001", "111010000", "100110100", "000010111",
    ...
    for(iter=0;iter<200;iter++)
    {
        ...
        for (i = 0; i < size; i++) {
            for (j = 0; j < size; j++) {
                if (bond_map[i][j] != 0) {
                    M[i][j] = HitOrMiss(pixel_stream[i][j], con_mask, 46);
                }
                else { M[i][j] = 0; }
            }
        }
    ...
    if (!(file=fopen("/Users/wenjun/ee569/hw3/pattern4_thinning.raw","wb"))) {
        cout << "Cannot open file: " << endl;
        exit(1);
    }
