...
# change the parameter in num_kernels: num_kernel = AC_kernel + DC_kernel(DC is always '1')
...
flags.DEFINE_string("num_kernels", "15,49", "Num of kernels for each stage. Format: '4,10'")
...
def main():
    ...
    # save data
    fw = open('pca_params_compact_15_49.pkl', 'wb')
    pickle.dump(pca_params, fw)
    fw.close()

    # load data
    fr = open('pca_params_compact_15_49.pkl', 'rb')
